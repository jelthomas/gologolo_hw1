...
export const AppsterGUIId = {
    ...
    APPSTER_ILLEGAL_LENGTH_CONFIRM_MODAL: 'appster_illegal_length_confirm_modal',
    APPSTER_ILLEGAL_LENGTH_CONFIRM_MODAL_FRAME: 'appster_illegal_length_confirm_modal_frame',
    APPSTER_ILLEGAL_LENGTH_CONFIRM_MODAL_HEADER: 'appster_illegal_length_confirm_modal_header',
    APPSTER_ILLEGAL_LENGTH_CONFIRM_MODAL_SECTION: 'appster_illegal_length_confirm_modal_section',
    APPSTER_ILLEGAL_LENGTH_CONFIRM_MODAL_OK_BUTTON: 'appster_illegal_length_confirm_modal_ok_button',
    APPSTER_ILLEGAL_LENGTH_CONFIRM_MODAL_FOOTER: 'appster_illegal_length_confirm_frame',
...
export const AppsterText = {
    ...
    APPSTER_ILLEGAL_LENGTH_CONFIRM_MODAL_PROMPT_TEXT: "appster_illegal_length_confirm_modal_prompt_text",
    APPSTER_ILLEGAL_LENGTH_CONFIRM_MODAL_OK_BUTTON_TEXT: "appster_illegal_length_confirm_modal_ok_button_text",
    APPSTER_ILLEGAL_LENGTH_CONFIRM_MODAL_FOOTER_TEXT: "appster_illegal_length_confirm_modal_footer_text",
